...
import { disposeHandwritingSvgPlaneGroup } from "../utils/handwritingSvgPlane.js";
...
/**
 * 배경 메쉬에 대해 위에서 아래로 레이를 쏴 "섬(또는 섬 위 오브제) 위의 점"인지 판별한다.
 * applyModel에서 Mesh.raycast가 막혀 있으므로 THREE.Mesh.prototype.raycast.call(mesh, ...) 로 직접 호출한다.
