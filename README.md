...
|------|--------|-------|:----------:|------|
| `/` | - | - | - | `/dev`로 리다이렉트 |
| `/dev` | DevPage | 2, 3, 6 | ✅ | 개발용, Stage 2/3/6 테스트 |
| `/beam` | BeamPage | 2 | ❌ | 빔 프로젝터 전용 |
| `/kiosk` | KioskPage | 3, 6 | ❌ | 체험 존 (포탈로 3→6) |
| `/memory-test` | MemoryTestPage | 2, 3, 6 | ❌ | 메모리 누수 테스트 |
| `*` | - | - | - | 404 시 `/dev`로 리다이렉트 |
